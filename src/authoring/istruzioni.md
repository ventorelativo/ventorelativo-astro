...
| `date`           | Data di pubblicazione                   | sì             | Data di **pubblicazione**, non dell'evento. Formato `AAAA-MM-GG`. Decide l'ordine in cui compaiono le news.                                                                                                                                                                                                                                                                                                           |
...
| `description` | Descrizione per Google | no           | Una o due frasi che dicano dove si trova e cosa ci si vola, per chi lo cerca su Google e non sa cos'è. **Nomina il comune e i paesi vicini**: è così che la gente lo trova. Diversa dalla scheda breve, che è fatta di sigle e numeri e a un motore di ricerca non dice niente. Massimo 160 caratteri: oltre, Google taglia. |
...
| `sections` | Sezioni della home | sì           | Le cinque fasce della home: Dove voliamo, Eventi e news, I nostri voli, Iscriversi, Contatti. Per ognuna un Titolo, un Testo introduttivo (una o due frasi, si può lasciare vuoto) e il Testo del link in fondo. Dove porta il link non si cambia. Non è qui che si scrivono i siti, le news o le quote: quelli arrivano dalle loro schede. |
