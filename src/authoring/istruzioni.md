...
| `sections` | Sezioni della home | sì           | Le quattro fasce della home: Dove voliamo, Eventi e news, I nostri voli, Iscriversi. Per ognuna un Titolo, un Testo introduttivo (una o due frasi, si può lasciare vuoto) e il Testo del link in fondo. Dove porta il link non si cambia. Non è qui che si scrivono i siti, le news o le quote: quelli arrivano dalle loro schede. |
